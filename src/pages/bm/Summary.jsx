...
export default function BMSummary() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      setAiResult(result);
      logActivity({ userId: user.id, role: user.role, action: 'bm_summary_generated', metadata: { member_count: targets.length } });
    } catch (e) {
  ...
  async function handleSave(memberId) {
    ...
    try {
      ...
      logActivity({ userId: user.id, role: user.role, action: 'bm_summary_saved', entityId: memberId });
